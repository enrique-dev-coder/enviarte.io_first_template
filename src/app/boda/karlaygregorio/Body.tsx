...
const textOlive = "text-[#BFB555]";
const bgOlive = "bg-[#D3AF37]";
    ...
    <InvitationContainer spBackground="none" songLink="/assets/songs/kyg.mp3">
      ...
      <div className={` my-5`}>
        ...
        >
          ...
          <br />
          <span
            className={`${montse.className} text-[#D3AF37] text-2xl uppercase`}
          >
            {" "}
      ...
      <div className=" bg-white py-8">
        ...
        <div>
          ...
          >
            <p
              className={`text-2xl font-bold ${textOlive} ${montse.className}`}
            >
              Papás de la novia
            </p>
            <p
              className={`${dancing.className} text-[#D3AF37]  text-[28px]  font-bold`}
            >
              ESMERALDA PONCE{" "}
            </p>
            <p
      ...
      <Contador
        ...
        fechaString="Sábado, 13 de Diciembre de 2025"
      ...
      <PlaceCard
        ...
        hora={"6:00 pm "}
        nombre={{
          content: " IGLESIA ESPIRITU SANTO ",
          color: textOlive,
          font: lora,
        }}
      ...
      <div className="w-6/12 flex flex-col justify-center items-center cell:w-full">
        ...
        <p className="  text-4xl mb-4 cell:text-xl cell:mb-1 text-[#D3AF37]">
          Vestido Largo
        </p>
        <div className="p-4">
          <p className="  border-2 border-[#D3AF37] text-[#D3AF37] rounded   font-medium  text-4xl text-center p-4 mb-4 cell:text-xl cell:mb-1">
      ...
      <div className="w-6/12 flex flex-col justify-center items-center cell:w-full">
        ...
        <p className="  text-4xl mb-4 cell:mb-1 cell:text-xl text-[#D3AF37]">
          Traje Formal
        </p>
        <div className="p-4">
          <p className="  rounded text-[#D3AF37]   font-medium  text-4xl text-center p-4 mb-4 cell:text-xl cell:mb-1">
            * No Mezclilla
          </p>
        </div>
      </div>
      ...
      <div className=" shadow-md text-center border-2  rounded-md m-2 p-2 border-[#D3AF37] ">
        <motion.h2
          initial={{ opacity: 0, y: 5 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ ease: "easeInOut", duration: 1 }}
