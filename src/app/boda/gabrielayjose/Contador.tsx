...
const Contador = ({
  ...
  return (
    ...
    >
      <div className="bg-black/30 w-11/12 text-white py-3 px-6 rounded-md">
        <motion.p
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
          transition={{ ease: "easeInOut", duration: 1 }}
        ...
        <motion.p
          ...
          transition={{ ease: "easeInOut", duration: 1 }}
          viewport={{ once: true }}
          className={`${lora.className}   text-center text-[20px] font-bold mb-[32px] 

           cell:mb-[16px] cell:w-[80%] cell:mx-auto`}
        >
          {fechaString}
        </motion.p>
