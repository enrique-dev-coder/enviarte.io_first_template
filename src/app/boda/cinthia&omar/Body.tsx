...
import buquet from "/public/assets/images/bouquet.png";
import champagen from "/public/assets/images/champagne-glass.png";
import camara from "/public/assets/images/camara.png";
...
//images
import imgBanner from "/public/assets/images/cinthia&omar/img1.jpeg";
import img2 from "/public/assets/images/cinthia&omar/img2.jpeg";
import img3 from "/public/assets/images/cinthia&omar/img3.jpeg";
import img4 from "/public/assets/images/cinthia&omar/img4.jpeg";
import img5 from "/public/assets/images/cinthia&omar/img5.jpeg";
import img6 from "/public/assets/images/cinthia&omar/img6.jpeg";
import img7 from "/public/assets/images/cinthia&omar/img7.jpeg";
...
const Body = ({
  ...
  return (
    <InvitationContainer
      spBackground="none"
      songLink="/assets/songs/cinthyayomar2.mp3"
    >
      <IngresarBoton
        buttonText="Ingresar"
        bgCuadrito="bg-white"
        extraClases=" !mt-[144px] !bg-transparent "
        font={paris}
        novia="Cinthia"
        novio="Omar"
        join="y"
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <Image src={img2} alt="boda" className="" />
      </motion.div>
      ...
      <div className="bg-gradient-to-br from-[#f3ede5] via-[#ffffff] to-[#e9e2d8] py-10 ">
        <div className="max-w-sm mx-auto">
          <Contador
            fechaEvento={new Date("2026-11-14T00:00:00")}
            fechaString="Sábado, 14 de Noviembre de 2026"
          ...
          <div className="relative bg-white w-11/12 p-3  mx-[auto] shadow-lg  mt-[140px] border-gray-300 text-center">
            <div className="border-2 border-[#6b705c] pt-[60px] pb-[40px] px-[20px]">
              ...
              <div className="mt-6 text-[14px] text-gray-700 leading-5">
                ...
                <p className="uppercase">ALICIA MONSIVAIS RANGEL</p>
                <p className="uppercase">FRANCISCO JAVIER MARTINEZ MACIAS </p>

                <p className="uppercase font-semibold mt-4">Padres del novio</p>
                <p className="uppercase">MARIA ANSELMA ALVARADO MARTINEZ</p>
                <p className="uppercase">LEONARDO FLORES ESTRADA ♰ </p>
              </div>
              ...
              <p className="mt-6 uppercase text-[14px] text-gray-600 italic">
                &quot;ELLA ORO, EL ORO Y DIOS OBRO EMPIEZA EL RESTO DE NUESTRA
                HISTORIA GRACIAS A EL &quot;
              </p>
      ...
      <div className="flex justify-center  w-full">
        ...
        >
          ...
          <div className="text-center mt-2">
            <p className=" tracking-widest font-bold">NOVIEMBRE</p>
          </div>
          <div className="uppercase my-2 flex items-center justify-center gap-2 ">
            ...
            <div className="border-y-2 border-white text-[14px]">8:30 PM</div>
          </div>
          ...
          <div className="mt-6 flex justify-center">
            <img
              src={noviosverde.src}
              alt="iglesia"
              className="w-[84px] brightness-0 invert"
            />
          </div>

          <div className="text-center mt-4">
            <p className={`${paris.className} text-3xl`}>Recepción</p>
            <p className=" tracking-widest mt-1 text-center text-xl">
              Villa Ferre{" "}
            </p>
            <p className=" tracking-widest mt-1 text-center">8:30 pm </p>
            <p className=" tracking-widest mt-1 text-center">
              Blvd. Venustiano Carranza 8550, Valle Hermoso, 25207 Saltillo,
              Coah.
            </p>
          </div>
          ...
          <div className="flex justify-center mt-6">
            <a
              href="https://maps.app.goo.gl/1vDWCLaCh21w9WS6A"
  ...
  return (
    ...
    >
      <div className="text-[#6b705c] bg-white shadow-md w-[280px] rounded-3xl p-4">
        ...
        {/* Color reservado para damas */}
        <div className="mt-4">
          <p className="uppercase tracking-widest text-center text-[11px]">
            Color reservado para las damas
          </p>

          <div className="flex items-center justify-center gap-2 mt-2">
            <span className="w-4 h-4 rounded-full bg-[#046307] border border-[#6b705c]/20" />
            <span className="uppercase tracking-widest text-[12px] font-semibold">
              Esmeralda
            </span>
          </div>
        </div>

        {/* Colores exclusivos de la novia */}
        <div className="mt-4 pt-3 border-t border-[#6b705c]/20">
          <p className="uppercase tracking-widest text-center text-[11px] font-bold">
...
export function Itinerario() {
  const eventos = [
    ...
    {
      hora: "3:00 A.M.",
      titulo: "Final del evento",
      icono: cierre.src,
    },
  ];

  const IconoVerde = ({ src, alt }: { src: string; alt: string }) => (
    <span
      role="img"
      aria-label={alt}
      className="block w-12 h-12 bg-[#6b705c] opacity-80"
      style={{
  ...
  return (
    ...
    >
      <div className="flex justify-center">
        ...
        >
          <div className="triangle-top h-[68px] shadow-xl bg-gradient-to-br from-[#f3ede5] via-[#ffffff] to-[#e9e2d8]" />
          ...
          <div className="relative mb-10">
            {/* Línea vertical */}
            <div className="absolute left-1/2 top-0 -translate-x-1/2 w-[2px] h-full bg-gray-400" />
                ...
                >
                  <div className="flex items-center mb-12 relative">
                    ...
                    <div className="w-1/2 text-right pr-6">
                      {textoIzquierda ? (
                        <>
                          <p className="text-[14px]">{evento.hora}</p>
                        ...
                        <div className="flex justify-end">
                          <IconoVerde src={evento.icono} alt={evento.titulo} />
                        </div>
                      )}
                    </div>
                    ...
                    <div className="relative z-10">
                      <div className="w-3 h-3 bg-[#6b705c] rounded-full" />
                    </div>
      ...
      <div className="triangle-bottom absolute w-full translate-y-[-68px] h-[68px] bg-gradient-to-br from-[#f3ede5] via-[#ffffff] to-[#e9e2d8]" />
    </motion.div>
  );
}
      ...
      <div className="bg-white shadow-md  rounded-3xl text-[#6b705c] max-w-sm mx-auto my-8 w-[320px]">
        <div className="text-center p-4">
          ...
          <p className=" uppercase tracking-widest mt-3 font-semibold text-center">
            ...
            <b>1 de Octubre de 2026</b>{" "}
          </p>
          <div className="flex justify-center mt-6">
            <a
              href="https://w.app/sngjiv"
              className="bg-[#6b705c] text-white px-6 py-2 tracking-widest shadow-md hover:shadow-lg transition"
            >
              Confirmar
            </a>
