...
const Numero = ({ num, desc }: { num: any; desc: string }) => {
  return (
    ...
    >
      ...
      >
        <p className=" text-5xl mb-4 cell:text-3xl text-[#87284d]  ">{num}</p>{" "}
      </div>
      <p className="text-xl uppercase cell:text-sm text-[#87284d] ">{desc}</p>
    </motion.div>
  );
};
    ...
    >
      <div className="bg-white/80 w-11/12 text-white py-3 px-6 rounded-md">
        <motion.p
          ...
          transition={{ ease: "easeInOut", duration: 1 }}
          viewport={{ once: true }}
          className={`${dancing.className} text-[#87284d]  text-center text-[40px] mb-[32px] 
        ...
        <motion.p
          ...
          transition={{ ease: "easeInOut", duration: 1 }}
          viewport={{ once: true }}
          className={`${lora.className} text-[#87284d]   text-center text-[28px] font-bold mb-[32px] 
        ...
        <p
          className={`${lora.className} text-[#87284d]   text-center text-3xl cell:text-3xl`}
        >
          Sólo faltan:
        </p>
