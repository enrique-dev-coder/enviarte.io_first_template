...
import imgHero from "/public/assets/images/arely&bryan/hero.jpeg";
  ...
  return (
    <>
      <div
        ...
        className=" h-screen  bg-cover bg-center   bg-fixed bg-no-repeat  bg-blend-overlay bg-black/20 "
      >
        <motion.div
