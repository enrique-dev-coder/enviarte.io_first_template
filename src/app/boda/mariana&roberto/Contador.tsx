...
const Numero = ({ num, desc }: { num: any; desc: string }) => {
  return (
    ...
    >
      ...
      >
        <p className=" text-5xl mb-4 cell:text-3xl text-[#590b18]  ">{num}</p>{" "}
      </div>
      <p className="text-xl uppercase cell:text-sm text-[#590b18] ">{desc}</p>
    </motion.div>
  );
};
...
const Contador = ({
  ...
  return (
    ...
    >
      <div className="bg-[#f5ebd0]/80 w-11/12 text-white py-3 px-6 rounded-md">
        <motion.p
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
          transition={{ ease: "easeInOut", duration: 1 }}
          viewport={{ once: true }}
          className={`${dancing.className} text-[#451c20] font-extrabold  text-center text-[40px] mb-[32px] 
        ...
        <motion.p
          ...
          transition={{ ease: "easeInOut", duration: 1 }}
          viewport={{ once: true }}
          className={`${lora.className} text-[#590b18]   text-center text-[28px] font-bold mb-[32px] 
        ...
        <p
          className={`${lora.className} text-[#590b18]   text-center text-3xl cell:text-3xl`}
        >
          Sólo faltan:
        </p>
