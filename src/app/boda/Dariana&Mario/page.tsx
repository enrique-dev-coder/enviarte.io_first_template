...
export const metadata = {
  ...
  openGraph: {
    siteName: "Dariana & Mario",
    title: "Dariana & Mario - Nuestra Boda",
    description:
      "Te invitamos a celebrar nuestra boda. Haz clic para más detalles.",
    url: "https://www.invitandofacil.com/boda/Dariana&Mario",
    images: [
      {
        url: "https://www.invitandofacil.com/assets/images/darianaymario/img10.jpeg",
        width: 256,
        height: 425,
