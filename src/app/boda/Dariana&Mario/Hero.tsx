...
import imgHero from "/public/assets/images/darianaymario/img10.jpeg";
    ...
    `,
      ...
      >
        <motion.div
          ...
          className=" h-full flex flex-col  justify-start items-center pb-20"
        >
          <motion.div
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
          ...
          >
            ...
            >
              {/* S (ATRÁS) */}
              <span
                className="absolute text-[232px] translate-x-[48px] translate-y-[48px] text-[#EDE3D2] tracking-wide z-0 opacity-80"
                style={{
                  textShadow: `
      ...
      `,
              ...
              {/* G (ADELANTE) */}
              <span
                className="relative text-[232px] text-[#EDE3D2] tracking-wide z-10"
                style={{
                  textShadow: `
