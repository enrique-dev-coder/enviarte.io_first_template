...
const Numero = ({ num, desc }: { num: any; desc: string }) => {
  return (
    ...
    >
      ...
      <p className="text-xl uppercase cell:text-sm text-[#7f5539] ">{desc}</p>
    </motion.div>
  );
};
...
const Contador = ({
  ...
  return (
    ...
    >
      <div className="bg-[#dcd3c4]/80 w-11/12 text-white py-3 px-6 rounded-md">
        <motion.p
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
          transition={{ ease: "easeInOut", duration: 1 }}
          viewport={{ once: true }}
          className={`${dancing.className} text-[#7f5539]  text-center text-[40px] mb-[32px] 
        ...
        <motion.p
          ...
          transition={{ ease: "easeInOut", duration: 1 }}
          viewport={{ once: true }}
          className={`${lora.className} text-[#7f5539]   text-center text-[28px] font-bold mb-[32px] 
        ...
        <p
          className={`${lora.className} text-[#7f5539]   text-center text-3xl cell:text-3xl`}
        >
          Sólo faltan:
        </p>
