...
import SendInviteTableRow from "@/components/Dashboard/EnviarLista/SendInviteTableRowPublic";
import axios from "axios";
import { useCookies } from "react-cookie";

const UploadZonePublic = ({ linkParaEnviar }) => {
  ...
  return (
    <>
      {isSuccess ? (
        ...
        <div className=" w-full h-[50vh] relative bg-gray-100  rounded-md flex items-center justify-center border-2 border-dashed border-emerald-500 ">
...
export default UploadZonePublic;
