  ...
  return (
    ...
    >
      ...
      <p className="text-center text-xl my-3 cell:text-xl cell:px-4 ">
        We have considered{" "}
        <span className="font-bold text-2xl">{pasesAsignados}</span> places for
        you
      </p>
      <form
      ...
      >
        <div className="flex flex-col w-full">
          <label className=" text-xl font-medium cell:text-lg">Name *</label>
          <input
            {...register("nombre")}
            type="text"
        ...
        <>
          {cookies?.invitandofacil_invitado?.id ? (
            ...
            >
              Thank you very much for confirming your attendance, if you change
              your opinion please contact us{" "}
            </div>
          ) : (
            <>
              <div
                  ...
                  <div className="flex gap-2  items-center">
                    <div className="flex gap-2 items-center">
                      ...
                      <label className=" font-bold">
                        No attend {styling?.section.carita === "si" && "😥"}
                      </label>
                    </div>
                  </div>
                  {ArrayPases.map((i) => (
